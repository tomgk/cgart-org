<?php /* Smarty version Smarty-3.0.5, created on 2011-05-18 19:57:36
         compiled from "/var/www/web220/html/data-private/template/base/main.tpl.html" */ ?>
<?php /*%%SmartyHeaderCode:16105430774dd40890df24e2-42936985%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c37bfc352e73918ec2901d6d191531fd8e9d90cc' => 
    array (
      0 => '/var/www/web220/html/data-private/template/base/main.tpl.html',
      1 => 1305741416,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16105430774dd40890df24e2-42936985',
  'function' => 
  array (
  ),
...
base/main.css" />
        ...
        <style type="text/css">
            #logo
            {
                background-image: url('<?php echo $_smarty_tpl->getVariable('pic_path')->value;?>
<?php echo $_smarty_tpl->getVariable('skin')->value['header_bg_img'];?>
');
            }
        </style>
...
" /><?php }?>
    ...
    <body>
        <div id="container">
            <div id="header">
                <h1 id="logo"><a href="<?php echo $_smarty_tpl->getVariable('wurl')->value;?>
