...
{
    public static function getParsedArticle($article_id)
    {
    ...
    public function call($menupath, $query, $post, $cfg)
    {
        ...
        $model = self::getParsedArticle($article_id);
...
#        echo '/',$class,'</p>';
    ...
    {
        $content = preg_replace_callback('/<pic (.*?)>/', array('article_controller', 'pic'), $content);
        return $content;
    }
